...
async function run() {
  ...
  const actionLinkLine: MessageLine = {
    id: 'action-link',
    content: `<https://github.com/mobalyticshq/ngf-configuration/actions/runs/18373372714/job/52341648705|View action Details>\n`,
  ...
  await slackManager.sendMessage([
    {
      id: 'start-pipeline',
      content: `DRY RUN pipeline for v01 PoE :poe-2: DEV`,
      emoji: ':test_tube:',
    },
    actionLinkLine,
  ]);
  ...
  await slackManager.appendNewLine({
    ...
    content: `Something went wrong during schema validation! Please contact any engineer. <https://github.com/mobalyticshq/ngf-configuration/actions/runs/18373372714/job/52341648705|See pipeline logs>`,
    emoji: ':mild-panic:',
  });
