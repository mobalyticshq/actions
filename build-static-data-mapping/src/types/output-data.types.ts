...
export type TooltipStructureTags = { type: 'tags'; value: { name: string; icon?: string }[] };

export type TooltipStructureBulletList = {
  type: 'bullet-list';
  value: { title: ReactNode; listStyleImageUrl?: string; color?: string }[];
};
...
export type TooltipStructureStats = {
  type: 'stats';
  value: { name: ReactNode; value: ReactNode; labelFirst?: boolean }[];
};
export type TooltipStructureDescription = { type: 'description'; value: string };
export type TooltipStructureFlavor = { type: 'flavor'; value: string };
export type TooltipStructureDataList = {
  type: 'data-list';
  value: { icon?: string; name: string; description: string }[];
};
